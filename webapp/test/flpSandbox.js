		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#gfexpetrobrasfornmanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gfexpetrobrasfornmanager-display": {
								"semanticObject": "gfexpetrobrasfornmanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gfex.petrobras.fornmanager",
									"url": sap.ui.require.toUrl("gfex/petrobras/fornmanager")
								}
							}
						}
					}
